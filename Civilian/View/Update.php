...
<html>
    ...
    <div class="container">
        ...
        <div class="form-left">
            <img src="../Images/Civ_Reg.jpg" class="civ-reg" alt="Civilian Update">
        </div>

        <div class="form-container">
            <h1 class="page-title">Civilian Update</h1>
        <form action="../Control/Update_User.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
        <table>
                    <tr>
                ...
                <tr>
                    <td></td>
                    <td><h4><a href="Home.php">Go to Home Page</a></h4></td>
                </tr>
        ...
        <script src="../JS/civ_update.js"></script>
    </body>
</html>