<?php
    ...
    $userID = $_SESSION["REP_ID"];
    include '../Control/View_User.php'; 
?>
<html>
<head>
  <link rel="stylesheet" href="../CSS/style_REP_Home.css?v=<?php echo time() ?>">
...
<div class="Home_page">
    <div class="left-section">
      ...
      <nav class="menu">
        ...
        <a href="#" onclick="ShowComplain()">Complains</a>
        <a href="#" onclick="ShowVIC()">Victims</a>
